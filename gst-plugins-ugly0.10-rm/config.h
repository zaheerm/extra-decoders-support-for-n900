...
#define GST_PACKAGE_NAME "GStreamer RealMedia Plugins (Maemo)"
...
/* Define to enable AMR-NB (used by amrnb). */
/* #undef HAVE_AMRNB */
...
/* Define to enable dvdnav library (used by dvdnav). */
/* #undef HAVE_DVDNAV */
...
/* Define to enable id3tag reading and writing from the MAD project (used by
   id3tag). */
/* #undef HAVE_ID3TAG */
