...
#define GST_PACKAGE_NAME "GStreamer MusePack Plugin (Maemo)"
...
/* Define if libcelt 0.4 is installed */
/* #undef HAVE_CELT_0_4 */
...
/* Define to enable dvdnav library (used by resindvd). */
/* #undef HAVE_DVDNAV */
...
#define PACKAGE_STRING "GStreamer Bad Plug-ins 0.10.13.1"
