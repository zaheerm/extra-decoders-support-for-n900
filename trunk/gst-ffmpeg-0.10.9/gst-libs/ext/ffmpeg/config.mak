...
FFMPEG_CONFIGURATION=--prefix=/usr --disable-ffserver --disable-ffplay --enable-postproc --enable-gpl --enable-static --enable-shared --disable-encoder=flac --disable-decoder=cavs --disable-protocols --disable-devices --disable-network --disable-vhook --disable-ffmpeg --enable-swscale
prefix=/usr
...
LN_S=ln -sf
STRIP=strip
OPTFLAGS=-g -Wall -O2 -Wno-error -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -std=c99 -fomit-frame-pointer -g -Wdeclaration-after-statement -Wall -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wundef -O3 -fno-math-errno
VHOOKCFLAGS=-fPIC
LDFLAGS= -Wl,-z,defs -Wl,-O1 -Wl,--as-needed -Wl,--warn-common -Wl,--as-needed -Wl,-rpath-link,$(BUILD_ROOT)/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavutil -Wl,-Bsymbolic
...
SRC_PATH="/home/zaheer/MyDocs/gst-ffmpeg-0.10.9/gst-libs/ext/ffmpeg"
SRC_PATH_BARE=/home/zaheer/MyDocs/gst-ffmpeg-0.10.9/gst-libs/ext/ffmpeg
BUILD_ROOT="/home/zaheer/MyDocs/gst-ffmpeg-0.10.9/gst-libs/ext/ffmpeg"
